...
export default class HowToPlay extends Component {
  ...
  changeLeftColor() {
    ...
    if (!stop) {
      this.setState({
        leftColor: {
          background: leftColorsArray[Math.floor(Math.random() * 4)]
        }
      });
      let id = setTimeout(changeLeftColor, Math.random() * 1000 + 500);
      timerIDs.push(id);
    }
  }
  ...
  changeRightColor() {
    ...
    if (!stop) {
      this.setState({
        rightColor: {
          background: rightColorsArray[Math.floor(Math.random() * 4)]
        }
      });
      let id = setTimeout(changeRightColor, Math.random() * 1000 + 500);
      timerIDs.push(id);
    }
  }
  ...
  changeLeftShape() {
    ...
    if (!stop) {
      ...
      let id = setTimeout(changeLeftShape, Math.random() * 1000 + 500);
      timerIDs.push(id);
    }
  }
  ...
  changeRightShape() {
    ...
    if (!stop) {
      ...
      let id = setTimeout(changeRightShape, Math.random() * 1000 + 500);
      timerIDs.push(id);
    }
  }
  ...
  moveWhiteCircle() {
    ...
    if (!stop) {
      this.setState({
        whiteCircle: {
          top: `${Math.floor(Math.random() * 423 + 4)}px`,
          left: `${Math.floor(Math.random() * 583 + 4)}px`
        }
      });
      let id = setTimeout(moveWhiteCircle, Math.random() * 1000 + 500);
      timerIDs.push(id);
    }
  }
  ...
  moveBlackCircle() {
    ...
    if (!stop) {
      ...
      let id = setTimeout(moveBlackCircle, Math.random() * 1000 + 500);
      timerIDs.push(id);
    }
  }
  ...
  setWinCondition() {
    const {
      winConditionsArray,
      colorConditionsArray,
      shapeConditionsArray,
      circleConditionsArray
    } = this;
    ...
    if (newWinCondition === "Color") {
      this.setState({
        soundCondition: colorConditionsArray[Math.floor(Math.random() * 8)]
      });
    } else if (newWinCondition === "Shape") {
      this.setState({
        soundCondition: shapeConditionsArray[Math.floor(Math.random() * 8)]
      });
    } else {
      this.setState({
        soundCondition: circleConditionsArray[Math.floor(Math.random() * 4)]
      });
    }
  }
  ...
  render() {
    ...
    if (
      soundCondition === "leftShapeSquare" &&
      leftShape === square &&
      !lsSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "leftShapeTriangle" &&
      leftShape === triangle &&
      !lsSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "leftShapeCircle" &&
      leftShape === circle &&
      !lsSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "rightShapeSquare" &&
      rightShape === square &&
      !rsSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "rightShapeTriangle" &&
      rightShape === triangle &&
      !rsSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "rightShapeCircle" &&
      rightShape === circle &&
      !rsSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "whiteCircleLeft" &&
      parseInt(whiteCircle.left, 10) < 270 &&
      !wcSound
    ) {
      conditionSound.play();
      this.wcSound = true;
    ...
    if (
      soundCondition === "whiteCircleLeft" &&
      parseInt(whiteCircle.left, 10) > 320
    ) {
      this.wcSound = false;
    }
    if (
      soundCondition === "whiteCircleRight" &&
      parseInt(whiteCircle.left, 10) > 320 &&
      !wcSound
    ) {
      conditionSound.play();
    ...
    if (
      soundCondition === "blackCircleLeft" &&
      parseInt(blackCircle.left, 10) < 270 &&
      !bcSound
    ) {
      conditionSound.play();
      this.bcSound = true;
    ...
    if (
      soundCondition === "blackCircleLeft" &&
      parseInt(blackCircle.left, 10) > 320
    ) {
      this.bcSound = false;
    }
    if (
      soundCondition === "blackCircleRight" &&
      parseInt(blackCircle.left, 10) > 320 &&
      !bcSound
    ) {
      conditionSound.play();
    ...
    return (
      <div className="game">
        <section className="shapeShift">
          <div
            className={
              gameTimer < 10 ? "gameCountDown gameCountDown9" : "gameCountDown"
            }
          >
            {gameTimer}
          </div>
